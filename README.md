...
> **Quotidian** *(adj.)* — "daily, everyday." Also hides your **quota**: the recurring allowance you burn through and that refills over time. That's the whole app.
...
- This endpoint is **not officially documented by Anthropic**. The exact field names/response shape used here were inferred from third-party tools and verified against the live endpoint during development; they may need adjusting if Anthropic changes it — see "Known limitations" below.
...
cp -R Quotidian.app /Applications/
```
